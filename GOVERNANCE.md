...
`cloud-itonami-isco-7319` is an OSS open-occupation blueprint. Governance covers
...
- Craft Coordination Governor remains independent of the advisor.
...
- real artisan/workshop/operator data stays outside Git.
...
- mishandling artisan/workshop/operator data
